                ...
                <div className={styles.container_right_side}>
                  <div className='w-full'>
                    ...
                    <button
                      ...
                      className={`${
                        isAccessing
                          ? 'bg-gray-600 active:bg-gray-600 hover:bg-gray-600'
                          : 'bg-yellow-500 active:bg-yellow-600 hover:bg-yellow-700'
                      } block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150  border border-transparent rounded-lg  focus:outline-none focus:shadow-outline-blue`}
                      type='submit'
                    >
                      Giriş Yap
                    </button>
                    ...
                    <div className='mt-4 text-center gap-2 flex justify-center items-center flex-col'>
                      <p className='text-md text-black'>
                        ...
                        <Link
                          href={`/auth/register/${pageRole.toLowerCase()}`}
                      ...
                      <p
                        className={`text-md bg-cst_red p-2 rounded ${
                          popupData.popupIsActive ? 'block' : 'hidden'
                        }`}
                      >
                        Mailiniz Doğrulanmamış mı?
                        <Link
